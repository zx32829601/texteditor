...
public class DefineImageButton {
    ...
    public ImageIcon getBottomlineIcon() {
        return bottomlineIcon;
    }
    ...
    public ImageIcon getItalicsIcon() {
        return italicsIcon;
    }

    public ImageIcon getLeftalignIcon() {
    ...
    public ImageIcon getNumberlistIcon() {
        return numberlistIcon;
    }

    public ImageIcon getRhombusIcon() {
        return rhombusIcon;
    }

    public ImageIcon getRightalignIcon() {
