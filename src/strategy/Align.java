...
public class Align implements ActionListener {
    ...
    public Align(UI ui, JTextPane jtextPane) {
        ...
        leftAlignButton = createAlignButton("靠左對齊","leftAlign",defineImageButton.getLeftalignIcon());
        centerButton = createAlignButton("置中對齊","center",defineImageButton.getCenterIcon());
        rightAlignButton = createAlignButton("靠右對齊","rightAlign",defineImageButton.getRightalignIcon());
